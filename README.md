...
### Results
![Class_distribution](class_distribution.png){: style="width:60%;" }
![Dim_reduction](dim_reduction.png){: style="width:60%;" }
![Text_length_statistics](text_length_statistics.png){: style="width:60%;" }
